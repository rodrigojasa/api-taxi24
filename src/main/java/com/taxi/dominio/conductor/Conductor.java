...
//  informacion de ubicacion
    ...
    public void setNombre(String nombre) throws Exception {
        if (nombre == null) {
            throw new OperationNotPermittedTaxiException("El nombre del conductor es requerido");
        }
    ...
    public void setApellidoPaterno(String apellidoPaterno) throws Exception {
        if (apellidoPaterno == null) {
            throw new OperationNotPermittedTaxiException("El apellido paterno del conductor es requerido");
        }
    ...
    public void setApellidoMaterno(String apellidoMaterno) throws Exception {
        if (apellidoMaterno == null) {
            throw new OperationNotPermittedTaxiException("El apellido materno del conductor es requerido");
        }
    ...
    public void setRfc(String rfc) throws Exception {
        if (rfc == null) {
            throw new OperationNotPermittedTaxiException("El rfc del conductor es requerido");
        }
